			...
			<div class="card-body">
			    <form  method="POST">
				  	<div class="mb-3" >
				    	...
				    	<input type="text" class="form-control" name="forget-password-email" > 
				  	</div>
				  	<a href="studentlogin.php" class="btn btn-outline-success" role="button">Back</a>
				  	<button type="submit" class="btn btn-outline-success "  name="forget-password">Send Link</button>
				</form>
			</div>
		</div>
	</div>
...
<?php
	...
	if(isset($_POST['forget-password'])){
		...
		$email = mysqli_real_escape_string($connection,$_POST['forget-password-email']);
